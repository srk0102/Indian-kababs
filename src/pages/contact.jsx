    ...
    <section class="relative overflow-hidden dark:bg-gray-900 font-poppins">
        <div class="absolute bottom-0 left-0 hidden w-full h-full lg:block lg:w-4/12">
            <img class="object-cover w-full h-full"
                src="https://drive.google.com/thumbnail?id=1tPVdti_kUvvXR1WWDNUQITxxca5hHbV&sz=w1000" alt=""/>
        </div>
        <div class="container relative px-4 mx-auto">
            <div class="max-w-5xl mx-auto">
                <div class="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
                    ...
                    <div class="w-ful px-4 mb-8 lg:w-2/5 lg:mb-0">
                        ...
                        <div class="flex items-center mb-6">
                            ...
                            <p class="text-lg font-semibold text-gray-600 dark:text-gray-400">+1-ph number</p>
                        </div>
                        <div class="flex items-center mb-6">
                            <span
                                class="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                            ...
                            <p class="text-lg font-semibold text-gray-600 dark:text-gray-400">Email Address</p>
                        </div>
                        <div class="flex items-center mb-6">
                            <span
                            ...
                            <div>
                                <p class="mb-2 text-lg font-semibold text-gray-600 dark:text-gray-400">Address
                                </p>
                            </div>
                        </div>
                    </div>
